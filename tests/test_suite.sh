...
sh ../src/signal.sh testcode/example
echo "\n########## Running lists test ##########\n"
sh ../src/signal.sh testcode/test_lists
echo "\n########## Running advanced lists test ##########\n"
sh ../src/signal.sh testcode/test_dot_product
echo "\n########## Running modulo operator test ##########\n"
sh ../src/signal.sh testcode/example_extraOp